...
namespace RatedWalls4
{
    [Transaction(TransactionMode.Manual)]
    public class Command : IExternalCommand
    {

        #region Project Parameter Data
        ...
        {
            // Following good SOA (Service-Oriented Architecture) practices, first validate incoming parameters
            ...
            List<ProjectParameterData> dataResult
            ...
            while (it.MoveNext())
            {
                ...
                dataResult.Add(newProjectParameterData);
            }
            return dataResult;
        }
        ...
          /// <returns></returns>
        static bool AddProjectParameterBinding(Document doc,
        ...
        Category category)
        {
           ...
           = projectParameterData.Binding as InstanceBinding;
            ...
            if (instanceBinding != null)
            {
              ...
              = doc.Application.Create.NewInstanceBinding(cats);
            ...
            else
            {
              ...
              = doc.Application.Create.NewTypeBinding(cats);
        ...
        static void PopulateProjectParameterData(Parameter parameter,
          ...
          ElementSet elements)
        {
                ...
                if (projectParameterData.Definition != null)
                {
                    ...
                    if (!categories.Contains(projectInfoElement.Category))
                    {
                        ...
                        using (Transaction tempTransaction = new Transaction(doc))
                        {
                            ...
                            if (AddProjectParameterBinding(doc, projectParameterData,
                       projectInfoElement.Category))
                            {
                                // successfully bound
                                foundParameter = projectInfoElement.get_Parameter(
                           projectParameterData.Definition);
                                ...
                                firstWallTypeElement.Category))
                                        {
                                            // Successfully bound
                                            foundParameter = firstWallTypeElement.get_Parameter(
                                    projectParameterData.Definition);
                                        }
                                    }
                                    else
                                 ...
                                 projectParameterData.Definition);
                                    ...
                                    if (foundParameter != null)
                                    {
                                        PopulateProjectParameterData(foundParameter,
           ...
           in projectParametersData)
            ...
            //TaskDialog.Show("Revit", projectParametersData.ToString());
